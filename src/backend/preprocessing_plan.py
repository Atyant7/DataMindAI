...
class PreprocessingPlan:
    """Recommended preprocessing actions for the current dataset.

    This object describes recommendations only. The executable, model-specific
    preprocessing pipeline will be introduced with the ML engine.
    """
